...
<div>
    <p>
        Building solutions in code form for <b>{{ ACCOUNT_AGE }} years</b>,
        with a journey in <b>{{ REPOSITORIES }}</b> personal repositories and collaborations in
        <b>{{ REPOSITORIES_CONTRIBUTED_TO }}</b> open-source projects, accumulating a total of
        <b>{{ STARS }} stars ★</b>.
    </p>
</div>
<details>
